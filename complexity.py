...
def calc_complexity(visual_bridge_info):
    ...
    if visual_bridge_info['complexity'] == 0:
        visual_bridge_info['foreground_index'] = visual_bridge_info['foreground_index'] * 4.0
        visual_bridge_info['background_index'] = visual_bridge_info['background_index']* 4.0
    ...
    foreground_index = 3.0 + random.random()
